...
@objc public protocol BSWCollectionViewDelegateWaterfallLayout: UICollectionViewDelegate {
...
public enum BSWCollectionViewWaterfallLayoutItemRenderDirection: Int {
...
public  let BSWCollectionElementKindSectionHeader = "BSWCollectionElementKindSectionHeader"
public  let BSWCollectionElementKindSectionFooter = "BSWCollectionElementKindSectionFooter"
public class BSWCollectionViewWaterfallLayout: UICollectionViewLayout {
    ...
    public var itemRenderDirection: BSWCollectionViewWaterfallLayoutItemRenderDirection {
        didSet {
            invalidateLayout()
        }
    }
    ...
    public weak var delegate: BSWCollectionViewDelegateWaterfallLayout?
