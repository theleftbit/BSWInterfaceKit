...
class AzzurriViewController: UIViewController, ListStatePresenter {
    ...
    static func mockData() -> [PolaroidCollectionViewCell.VM] {
        ...
        let vm1 = PolaroidCollectionViewCell.VM(
            ...
            cellTitle: TextStyler.styler.attributedString("Gigi Buffon", forStyle: .headline),
        ...
        let vm2 = PolaroidCollectionViewCell.VM(
            ...
            cellTitle: TextStyler.styler.attributedString("Gianluca Zambrotta", forStyle: .headline),
        ...
        let vm3 = PolaroidCollectionViewCell.VM(
            ...
            cellTitle: TextStyler.styler.attributedString("Fabio Cannavaro", forStyle: .headline),
        ...
        let vm4 = PolaroidCollectionViewCell.VM(
            ...
            cellTitle: TextStyler.styler.attributedString("Marco Materazzi", forStyle: .headline),
        ...
        let vm5 = PolaroidCollectionViewCell.VM(
            ...
            cellTitle: TextStyler.styler.attributedString("Fabio Grosso", forStyle: .headline),
